...
class ElectricityChargesTest extends AnyFunSuite {
  test("ElectricityCharges.computeFinalBillTest1")
  {
  ...
  test("ElectricityCharges.computeFinalBillTest5")
  {
